...
def create_checkerboard(location, rotation, width, height):
    ...
    add_driver(map_node.inputs[3], pattern_obj, 'default_value', 'CheckerboardSettings.width', 0)
    add_driver(map_node.inputs[3], pattern_obj, 'default_value', 'CheckerboardSettings.height', 1)
