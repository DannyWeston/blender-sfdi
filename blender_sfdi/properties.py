...
class PG_ProjSettings(bpy.types.PropertyGroup):    
    ...
    throw_ratio : bpy.props.FloatProperty(name="Throw Ratio", default=1.0, min=1.0) # type: ignore

    aspect_ratio : bpy.props.FloatProperty(name="Aspect Ratio", default=16.0/9.0, min=1.0) # type: ignore
